...
const Forms = () => {
  return (
    <div className="bg-gray-345 py-10">
      <form action="" className=" bg-[var(--foreground)] rounded-2xl p-8 flex flex-col gap-6">
        {/* First & Last Name Row */}
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg p-3 focus:outline-none bg-[var(--background)]"
            />
          </div>
        ...
        <div className="flex justify-end gap-4 mt-6">
          <Button title="Back to Home" className="bg-[var(--background)] rounded-[5]" />
