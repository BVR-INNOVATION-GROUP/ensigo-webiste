...
const Impact = () => {
    ...
    return (
        <div className='flex bg-pale-dark flex-col md:flex-row'>

            <img src="https://images.pexels.com/photos/192136/pexels-photo-192136.jpeg" className='w-full md:w-[50%]  object-cover' alt="" />

            <div className='w-full md:w-[50%] p-[5vw]'>
